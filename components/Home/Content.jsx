        ...
        >
            ...
            >
                <Box flex="1" maxW={{ lg: '5xl' }} mb={12} mx="auto">
                    ...
                    <Text
                        textAlign="center"
                        color={mode('gray.600', 'black')}
                        mt="4"
                        fontSize="lg"
                        fontWeight="medium"
                    >
                        James teaches web development with a focus on JavaScript and the Jamstack.
                        He specializes in video content, live coding and simplifying topics into
                        relatable content.
                    </Text>
                </Box>
                <SimpleGrid
                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Text color={mode('gray.600', 'white')}>
                                        {item?.description}
                                    </Text>
                                </Box>
                            </Link>
