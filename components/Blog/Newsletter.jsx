      ...
      >
        <Box maxW="md" mx="auto">
          ...
          <Box mt="6">
            ...
            <Text color={mode('gray.600', 'gray.400')} fontSize="sm" mt="5">
              By subscribing, you agree with Revue&apos;s <Box as="a" target="_blank" href="https://www.getrevue.co/terms">terms of service</Box> 
            </Text>
            <Text color={mode('gray.600', 'gray.400')} fontSize="sm" mt="5">
                and <Box as="a" target="_blank" href="https://www.getrevue.co/privacy">Privacy Policy</Box>
            </Text>
          </Box>
        </Box>
      </Box>
